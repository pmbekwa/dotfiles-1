...
plugins=(git github gem heroku rails3 ruby brew bundler cap compleat knife thor tmuxinator vi-mode pow powder osx history-substring-search thor rvm dirpersist)
